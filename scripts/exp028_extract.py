...
TH = np.radians(DEG)
K_VARIANTS = {"quintic 15-45": ([15,20,26.565,30,40,45], 5), "quartic 15-40": ([15,20,26.565,30,40], 4), "cubic 5-20": ([5,10,15,20], 3), "quad 5-15": ([5,10,15], 2), "cubic LSQ 5-26.6": ([5,10,15,20,26.565], 3), "quartic 5-26.6": ([5,10,15,20,26.565], 4)}
